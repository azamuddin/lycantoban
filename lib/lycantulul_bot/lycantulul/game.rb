module Lycantulul
  class Game
    ...
    def get_task(role)
      ...
      when PROTECTOR
        'Ngasih obat anti serigala ke orang-orang. Orang yang dapet obat anti serigala akan terlindungi dari serangan para serigala. Ntar tiap malem ditanyain mau jual ke siapa (sebenernya ga jualan juga sih, ga dapet duit, maap yak). Hati-hati loh tapi, kalo lu jual obat anti serigala ke serigala bisa-bisa lu dibunuh dengan 25% kemungkinan, kecil lah, peluang lu buat dapet pasangan hidup masih lebih gede :)'
      when SPY
